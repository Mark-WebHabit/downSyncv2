...
import { householdItems } from "../assets/household_flatfiledb_local.js";
...
const HouseHold = ({ navigation }) => {
  ...
  const animatedValues = householdItems.map(() => new Animated.Value(1));
      ...
      >
        <View style={styles.container}>
          <View style={styles.row}>
            {householdItems.slice(0, 3).map((part, index) => {
              return (
          ...
          <View style={styles.row}>
            {householdItems.slice(3, 7).map((part, index) => {
          ...
          <View style={styles.row}>
            {householdItems.slice(7, 10).map((part, index) => {
